...
import {VaultConfigV3_4, ErrorLibrary} from "./VaultConfigV3_4.sol";
...
import {PortfolioTokenV3_2} from "../v3_2/PortfolioTokenV3_2.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function _multiTokenDeposit(
        ...
        if (_permit.spender != address(this)) {
            revert ErrorLibrary.InvalidSpender();
        }
    ...
    function multiTokenWithdrawal(
        ...
        _portfolioTokenAmount = _burnWithdraw(
            msg.sender,
            _portfolioTokenAmount
        );
        ...
        emit Withdrawn(msg.sender, _portfolioTokenAmount, address(this));
    }
    ...
    function _msgData()
        ...
        view
        virtual
        override(Context, PortfolioTokenV3_2)
